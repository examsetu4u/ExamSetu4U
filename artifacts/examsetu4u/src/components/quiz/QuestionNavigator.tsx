...
export function QuestionNavigator({
  ...
  return (
    <div className="rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-4 shadow-[var(--shadow)] sm:p-5" data-testid="question-palette">
      ...
      >
        {questionIds.map((qId, idx) => {
          ...
          let bgClass = 'bg-[hsl(var(--secondary))] text-[hsl(var(--foreground))] border-[hsl(var(--border))]';
          let ariaLabel = `Question ${idx + 1}, Unanswered`;

          if (status === 'current') {
            bgClass = 'bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] border-[hsl(var(--primary))] ring-2 ring-[hsl(var(--accent))] ring-offset-2';
          ...
          return (
            <button
              ...
              className={`focus-ring flex h-10 w-full items-center justify-center rounded-lg border text-xs font-bold transition ${bgClass} hover:opacity-90 active:scale-95`}
      ...
      <div className="mt-4 grid grid-cols-2 gap-2 border-t border-[hsl(var(--border))] pt-3 text-[11px] text-[hsl(var(--muted-foreground))]">
        <div className="flex items-center gap-1.5">
          <span className="flex h-3.5 w-3.5 shrink-0 items-center justify-center rounded bg-[hsl(var(--primary))] ring-1 ring-[hsl(var(--accent))]"></span>
        ...
        <div className="flex items-center gap-1.5 col-span-2">
          <span className="flex h-3.5 w-3.5 shrink-0 items-center justify-center rounded border border-[hsl(var(--border))] bg-[hsl(var(--secondary))]"></span>
